<template>
    <div class="e-setting">
        <div class="e-setting-title">弹窗-手机报名</div>
        <div class="e-setting-scroll">
            <div class="e-setting-content bg-setting-container">
                <section class="setting-panel">
                    ...
                    <div class="creat-active-img-wrap">
                        <div class="img-wrap-select-wrap">
                            <div v-for="(item,index) in defaultImg_1" :class="step_5.initData.toastImg.index==index?'selected':''"
                                 class="img-wrap-select"
                                 @click="selectBg(index)">
                                <img :src="item.url" alt="">
                                <div v-if="step_5.initData.toastImg.index==index" class="selected-icon">
                ...
                <section class="setting-panel">
                    <div class="setting-head" style="justify-content: space-between">
                        ...
                        <div class="checkbox-wrap">
                            <label class="custom-checkbox"  for="is-show-name">
                                <span class="check-name">不显示</span>
                                <input id="is-show-name" @click="headBgCheck(step_5.isShowHeadBg)" v-model="step_5.isShowHeadBg" type="checkbox">
                                <i></i>
                            </label>
                        </div>
                    </div>
                    <div class="creat-active-img-wrap">
                        <div class="img-wrap-select-wrap">
                            <div v-for="(item,index) in defaultImg_2" :class="step_5.initData.headImg.index==index?'selected':''"
                                 class="img-wrap-select"
                                 @click="selectHead(index)">
                                <img :src="item.url" alt="">
                                <div v-if="step_5.initData.headImg.index==index" class="selected-icon">
                                    <img src="@/assets/img/icon-plug-selected.png" alt="">
                                </div>
                            </div>
                        </div>
                ...
                <section class="setting-panel">
                    ...
                    <div class="btn-setting-model">
                        <div class="setting-item-wrap">
                            <div class="setting-item" style="margin-bottom: 0" v-for="(item,index) in step_5.initData.setBtn"
                                 :key="index">
                                <span class="setting-name">{{item.name}}</span>
                                <span class="color-cell" :style="{backgroundColor: item.color}" ref="colorCellImg"
...
<script>
    ...
    export default {
        ...
        computed: {
            step_5(){
              return this.pageData.plug.step_5;
            },
            pageData() {
        ...
        methods: {
            // 是否显示头图
            headBgCheck(type) {
                Object.assign(this.pageData.plug.step_5, {isShowHeadBg: !type});
            ...
            selectBg(index) {
                ...
                Object.assign(this.pageData.plug.step_5, {setBgImg: obj});
                Object.assign(this.pageData.plug.step_5.initData.toastImg, {index: index});
            ...
            selectHead(index) {
                ...
                Object.assign(this.pageData.plug.step_5, {setHeadImg: obj});
                Object.assign(this.pageData.plug.step_5.initData.headImg, {index: index});
                this.$store.commit("updateActivitySource", JSON.parse(JSON.stringify(Object.assign({}, this.pageData))));
            },
            // 上传图片
            inputChangeBg({url}) {
                ...
                Object.assign(this.pageData.plug.step_5.initData.toastImg, {index: -1});
                Object.assign(this.pageData.plug.step_5, {setBgImg: obj});
                this.$store.commit("updateActivitySource", Object.assign({}, this.pageData));
            },
            inputChangeHead({url}) {
                ...
                Object.assign(this.pageData.plug.step_5.initData.headImg, {index: -1});
                Object.assign(this.pageData.plug.step_5, {setHeadImg: obj});
                this.$store.commit("updateActivitySource", Object.assign({}, this.pageData));
            ...
            setBgColor(color,insetHistoryState) {
                ...
                // 设置输入框
                if (type == 1) {
                    Object.assign(this.step_5.initData.setIntBorder[index], {color: color});
                    Object.assign(this.step_5.setInput, {[key]: color});
                }
                // 设置按钮
                if (type == 2) {
                    Object.assign(this.step_5.initData.setBtn[index], {color: color});
                    Object.assign(this.step_5.setBtn, {[key]: color});
                }
